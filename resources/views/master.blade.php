...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Theta</b></span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start notification -->
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> lesson 3, french has been cancelled
                    </a>
                  </li>
                  <!-- end notification -->
                </ul>
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="javascript:;">
              ...
              <div class="menu-info">
                <h4 class="control-sidebar-subheading">Next testweek</h4>
          ...
          <li>
            <a href="javascript:;">
              <h4 class="control-sidebar-subheading">
                time until test week
                <span class="pull-right-container">
                    <span class="label label-danger pull-right">2 days</span>
                  </span>
              </h4>
